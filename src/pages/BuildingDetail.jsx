...
const BUILDING_DESCRIPTIONS = {
  ...
  lares:
    "Lares Building is the center of many student activities at Abington, housing the cafeteria, bookstore, student affairs, health & wellness office, and more. Events are held in Lubert Commons almost daily.",
  lionsgate:
    "Opened in 2017, LionsGate is the main residential facility, offering 400 beds in apartment-style units.",
  woodland:
    "Woodland Building is a central campus building with offices and academic space. It also contains the campus Library, Art Gallery, Woodland Cafe and computer labs.",
  springhouse:
  ...
  athletic:
    "The Athletics building features facilities for campus recreation and teams with a court, indoor gym, and certain self-defence classes.",
  cloverly:
    "Cloverly building is not a building that is currently accessible for students during their spring and fall semester.",
};
...
const BUILDING_IMAGES = {
  ...
  cloverly: [{ id: "1", source: require("../assets/images/buildings/cloverly1.jpg") }],
};
        ...
        >
          ...
          <View style={s.slideshowContainer}>
            <FlatList
              ...
              renderItem={({ item }) => <Image source={item.source} style={s.image} />}
            />
            <View style={s.dots}>
              {images.map((_, i) => (
          ...
          <View style={s.section}>
            ...
            <Pressable style={s.btn} onPress={() => navigation.navigate("Search")}>
